...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/Users/lacy/workspace/danecarder.com/log/dane_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/Users/lacy/workspace/danecarder.com/cache/dane/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/Users/lacy/workspace/danecarder.com/apps/dane/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'sfPatternRouting');
      $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/Users/lacy/workspace/danecarder.com/cache/dane/dev/config/routing',
  'lifetime' => 31556926,
  'prefix' => '/Users/lacy/workspace/danecarder.com/apps/dane/routing',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/Users/lacy/workspace/danecarder.com/cache/dane/dev/template',
  'lifetime' => 86400,
  'prefix' => '/Users/lacy/workspace/danecarder.com/apps/dane/template',
)));
